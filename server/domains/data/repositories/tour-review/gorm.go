...
func (g *gormProvider) Create(ctx context.Context, m *models.TourReview) error {
...
func (g *gormProvider) Delete(ctx context.Context, id uuid.UUID) error {
	return errors.ErrSomethingWrong(g.logger, g.db.WithContext(ctx).Delete(models.NewTourReviewBuilder().Build(), "id=?", id.String()).Error)
}

// Update implements Repository
func (g *gormProvider) Update(ctx context.Context, m *models.TourReview) error {
...
func (g *gormProvider) GetByAll(ctx context.Context) (result models.SliceResult[models.TourReview]) {
	result.Error = errors.ErrRecordNotFound(g.logger, g.GetModelName(), g.db.WithContext(ctx).Find(&result.Value).Error)
	return result
}

// GetById implements Repository
func (g *gormProvider) GetById(ctx context.Context, id uuid.UUID) (result models.SingleResult[*models.TourReview]) {
