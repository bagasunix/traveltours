...
func (g *gormProvider) Delete(ctx context.Context, id uuid.UUID) error {
	return errors.ErrSomethingWrong(g.logger, g.db.WithContext(ctx).Delete(models.NewTourBuilder().Build(), "id=?", id.String()).Error)
}
...
func (g *gormProvider) GetAll(ctx context.Context) (result models.SliceResult[models.Tour]) {
